...
class Problem(object):
    ...
    def __init__(self, nvars, nobjs, nconstrs = 0, function=None, model = None):
    ...
    def evaluate(self, solution):
        ...
        if self.nconstrs > 0:
            (objs, constrs) = self.function(solution.variables,self.model)
        else:
            objs = self.function(solution.variables,self.model)
            constrs = []
